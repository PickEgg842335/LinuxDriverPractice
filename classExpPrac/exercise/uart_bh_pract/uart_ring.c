...
#ifdef __TASKLET_OLD__
void wakeup_tasklet (unsigned long arg)
#else
void wakeup_tasklet (struct tasklet_struct *unused)
#endif
{
    bSleep = 1;
...
#ifdef __TASKLET_OLD__
DECLARE_TASKLET_OLD(uart_tasklet, wakeup_tasklet);
#else
DECLARE_TASKLET(uart_tasklet, wakeup_tasklet);
#endif
