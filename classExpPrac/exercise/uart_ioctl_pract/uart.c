...
#endif
{
    ...
    case IOCTL_SET_BAUD:
        ...
        if(arg == 57600)        divisor = 2;
        else if(arg == 38400)   divisor = 3;
        else if(arg == 19200)   divisor = 6;
        else if(arg == 9600)    divisor = 12;
        else if(arg == 4800)    divisor = 24;
        else if(arg == 2400)    divisor = 48;
        reg = inb(PORT_COM1 + REG_LCR);
        outb((reg | DLR_ON), (PORT_COM1 + REG_LCR));
